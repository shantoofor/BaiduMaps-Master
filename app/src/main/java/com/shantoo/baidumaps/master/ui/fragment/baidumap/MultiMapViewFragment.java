...
public class MultiMapViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_multimap, container, false);
    }
    ...
    private void initMap() {
        ...
        SupportMapFragment map1 = (SupportMapFragment) (getChildFragmentManager().findFragmentById(R.id.map1));
        ...
        SupportMapFragment map2 = (SupportMapFragment) (getChildFragmentManager().findFragmentById(R.id.map2));
        ...
        SupportMapFragment map3 = (SupportMapFragment) (getChildFragmentManager().findFragmentById(R.id.map3));
        ...
        SupportMapFragment map4 = (SupportMapFragment) (getChildFragmentManager().findFragmentById(R.id.map4));
