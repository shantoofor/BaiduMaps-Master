...
public class LocationFragment extends Fragment {
    ...
    public void onResume() {
        ...
        super.onResume();
        //为系统的方向传感器注册监听器
        mSensorManager.registerListener(MySensorEventListener, mSensorManager.getDefaultSensor(Sensor.TYPE_ORIENTATION), SensorManager.SENSOR_DELAY_UI);
    }
